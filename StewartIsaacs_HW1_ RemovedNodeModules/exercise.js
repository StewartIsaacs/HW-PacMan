...
exercise.increment = 50; // pixels to move either + or -
exercise.direction = 0; // 0  = moving right 1 = moving left. 
...
exercise.checkWallCollision = function() {
    ...
    var imageWidth = exercise.img1.width;
    if (exercise.pos.x + imageWidth >= innerWidth){
        exercise.direction = 1;
